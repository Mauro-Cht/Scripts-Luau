...
-- Exemplo de Toggle para cada ESP do script
Tabs.ESP:AddToggle("IslandESP", {Title="Island ESP", Default=false, Callback=function(v) IslandESP=v end})
Tabs.ESP:AddToggle("ESPPlayer", {Title="Player ESP", Default=false, Callback=function(v) ESPPlayer=v end})
Tabs.ESP:AddToggle("ChestESP", {Title="Chest ESP", Default=false, Callback=function(v) ChestESP=v end})
Tabs.ESP:AddToggle("DevilFruitESP", {Title="DevilFruit ESP", Default=false, Callback=function(v) DevilFruitESP=v end})
Tabs.ESP:AddToggle("FlowerESP", {Title="Flower ESP", Default=false, Callback=function(v) FlowerESP=v end})
Tabs.ESP:AddToggle("RealFruitESP", {Title="RealFruit ESP", Default=false, Callback=function(v) RealFruitESP=v end})

-- Exemplo de botão para Hop
Tabs.Main:AddButton({
    Title = "Server Hop",
    Description = "Trocar de servidor",
    Callback = function()
        Hop()
    end
})

-- Exemplo de Dropdown com Mobs
Tabs.Farm:AddDropdown("Mobs", {
    Title="Selecionar Mob",
    Values={"Bandit","Monkey","Gorilla","Pirate"},
    Multi=false,
    Default=1,
    Callback=function(val)
        print("Mob selecionado:", val)
    end
})

-- Configura SaveManager e InterfaceManager
SaveManager:SetLibrary(Fluent)
InterfaceManager:SetLibrary(Fluent)
InterfaceManager:SetFolder("ScriptTsuoHub")
SaveManager:SetFolder("ScriptTsuoHub/este-jogo")
